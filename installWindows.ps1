...
$icons = "{20D04FE0-3AEA-1069-A2D8-08002B30309D}", "{59031a47-3f72-44a7-89c5-5595fe6b30ee}", "{645FF040-5081-101B-9F08-00AA002F954E}"
...
do{
    ...
    if(Get-ItemProperty 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\chrome.exe' -erroraction 'silentlycontinue')
    {
        ...
        .\SetUserFTA\SetUserFTA.exe .webp ChromeHTML
